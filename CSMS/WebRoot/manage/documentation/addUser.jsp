				...
				<div class="example-box">
					<div class="example-code" style="margin-left:180px;">
						<form action="" method="" >
							...
							<div class="form-row">
								<button type="submit"class="btn medium primary-bg" style="margin-left:10px;" title=""  onclick="javaScript:window.close();">
								<span class="button-content">确定</span></button>
								<button type="reset"class="btn medium primary-bg" style="margin-left:10px;" title=""  onclick="javaScript:window.close();">
