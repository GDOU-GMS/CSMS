				...
				<div class="tabs">
					<ul>
						<li><a href="#core-helpers-tabs-1" title="Tab 1"> <i
								class="glyph-icon icon-archive font-blue font-size-23"></i> </a>
						</li>
						<li><a href="#core-helpers-tabs-2" title="Tab 2"> <i
								class="glyph-icon icon-beaker font-black font-size-23"></i> </a>
						</li>
						<li><a href="#core-helpers-tabs-3" title="Tab 3"> <i
								class="glyph-icon icon-cogs font-green font-size-23"></i> </a>
						</li>
					</ul>
			...
			<div id="page-content">
				...
				<div class="example-box">
						...
						<form action="" method="">
							...
							<div class="form-row">
								...
								<div class="form-input col-md-3 textstyle"  >
									<input  type="text" style="width:200px;height:28px;" name=""
					...
					<div class="example-code">
						...
						<table class="table table-condensed">
							...
							<tbody>
								<tr>
									...
									<i class="glyph-icon icon-flag"></i> </a>  --> <a
										title=".icon-plus-square-o"
										class="tooltip-button btn small bg-yellow" title="添加" href="">
											<i class="glyph-icon icon-plus-square-o"></i>
									</a> <a href="javascript:;"
										class="btn small bg-blue-alt tooltip-button"
										data-placement="top" title="更新"> <i
											class="glyph-icon icon-edit"></i> </a> <a href="javascript:;"
										class="btn small bg-red tooltip-button" data-placement="top"
										title="删除"> <i class="glyph-icon icon-remove"></i> </a></td>
								</tr>
								<tr>
									<td>2</td>
						...
						<div class="col-md-3"
							style="float:right; margin-bottom:20px; width:500px;">
							<div class="button-group center-div">
								<a href="javascript:;" class="btn large ui-state-default"> <i
									class="glyph-icon icon-chevron-left"></i> </a> <a
									href="javascript:;" class="btn large ui-state-default"> 1 </a>
								<a href="javascript:;"
									class="btn large disabled ui-state-default"> 2 </a> <a
									href="javascript:;" class="btn large ui-state-default"> 3 </a>
								<a href="javascript:;" class="btn large ui-state-default"> 4
									...
									10 </a> <a href="javascript:;" class="btn large ui-state-default">
