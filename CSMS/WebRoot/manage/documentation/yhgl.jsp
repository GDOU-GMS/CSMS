...
<body>
	...
	<div id="page-wrapper">
			...
			<div id="sidebar-menu">
				<ul>
					...
					<li><a href="javascript:;" title="Components"> <i
						...
						<ul>
							<li><a href="aduUser.jsp" title="Dashboard panels" target="main-frame">
		...
		<div id="page-content-wrapper"  style="height: 700px;" >
			...
			<iframe src="aduUser.jsp" id="main-frame" name="main-frame" frameborder="no" width=100% height=100%></iframe>
