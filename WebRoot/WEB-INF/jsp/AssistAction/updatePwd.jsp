						...
						<form  action="${pageContext.request.contextPath}/user_renewPwd.do" method="post">
							<div class="form-row">
								...
								<div 
									...
									<input type="password" style="width:200px;height:28px;" name="password" placeholder="请输入原密码" required/>
								</div>
							...
							<div class="form-row">
								...
								<div 
									class="form-input col-md-3 textstyle">
									<input type="password" style="width:200px;height:28px;" name="newpwd1" placeholder="密码5-17，字母数字和下划线" pattern="[a-zA-Z0-9_]{5,17}" required/>
								</div>
							...
							<div class="form-row">
								...
								<div class="form-input col-md-3" >
									<input  type="password"style="width:200px;height:28px; margin-left:-10px;" name="newpwd2" placeholder="密码5-17，字母数字和下划线" pattern="[a-zA-Z0-9_]{5,17}" required/>
								</div>
